                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-10 portal-card-enter">
                                ...
                                {!editMode && (
                                    <div className="space-y-6">
                                        ...
                                        {profileForm.goals?.length > 0 && (
                                            <div className="bg-slate-50 rounded-xl border border-slate-100 p-5">
                                                <label className="text-xs text-slate-500 uppercase tracking-wider font-bold block mb-2">Wellness Goals</label>
                                ...
                                {editMode && (
                                    <form onSubmit={handleSaveProfile} className="space-y-5">
                                        ...
                                        <div>
                                            <label className="portal-label">Wellness Goals</label>
