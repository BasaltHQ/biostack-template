      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-slate-700">
          <section>
            ...
            <p>
              We collect information you provide directly to us when you fill out a form, request coaching, or
              communicate with us via third-party platforms. This includes your name, email address, phone number, and
              any health goals you choose to share.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>Process your requests and manage your coaching program.</li>
          ...
          <section>
            ...
            <p>
              If you have any questions about this Privacy Policy, please contact us at support@biostacklimitless.com.
            </p>
          </section>
        </div>
      </div>
